...
create_ip -name blk_men_gen -vendor xilinx.com -library ip -version 8.4 -module_name BLOCKMEM
set_property -dict [list CONFIG.Component_Name {BLOCKMEM} CONFIG.Use_Byte_Write_Enable {false} COMFIG.Write_Width_A {6} CONFIG.Write_Depth_A {64} CONFIG.Read_Width_A {6} CONFIG.Operating_Mode_A {READ_FIRST} CONFIG.Write_Width_B {6} CONFIG.Read_Width_B {6} CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex7/table.COE}] [get_ips BLOCKMEM]
